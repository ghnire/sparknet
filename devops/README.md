...
You need either a Ubuntu or Debian based system for sparknet.spark.nl, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/sparknet.spark.nl.yml` to the remote server with:
